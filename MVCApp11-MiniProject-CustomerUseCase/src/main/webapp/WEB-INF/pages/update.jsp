...
<form:form commandName="custCmd" method="POST">
  ...
  <div class="form-group col-md-2">
      ...
      <form:input path="cno" class="form-control" id="cno" placeholder="Customer Number" autocomplete="off" disabled="true"/>
    </div>
 ...
 <div class="container d-flex justify-content-center">
  <button type="submit" class="btn btn-primary w-25"><i class="fa fa-wrench fa-fw mr-2" aria-hidden="true"></i>Update Details</button>
  </div>
</form:form>
</div>
